      ...
      {Auctions.length !== 0 ? (
        <>
          {Auctions.map((a) => (
            <div
              key={a._id}
              className="flex flex-col md:flex-row border rounded-lg overflow-hidden shadow-md w-full max-w-2xl font-sans m-4 p-4 bg-white"
            >
              <img
                src={a.imageURL}
                alt="Oil Painting"
